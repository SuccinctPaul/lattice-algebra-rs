...
## Crate split (planned at workspace time)

```mermaid
flowchart LR
    subgraph WS["cargo workspace"]
        CORE["lattice-algebra-core<br/>L0–L2"]
        MODC["lattice-module<br/>L3"]
        CRYPTO["lattice-crypto<br/>L4"]
        PROTO["lattice-protocols<br/>L5"]
        PQC["ml-kem / ml-dsa / falcon<br/>L6"]
        ZKC["lattice-zk<br/>L5+L6"]
    end
    MODC --> CORE
    CRYPTO --> MODC
    PROTO --> CRYPTO
...
Until the split, module prefixes (`module::`, `crypto::`, `mldsa::`) reserve the namespaces.
