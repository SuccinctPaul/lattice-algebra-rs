...
contract between the design docs and `src/`: new code lands in the module that
owns it, and this page is updated the same day.
...
flowchart TB
    subgraph L6["L6 · Schemes"]
        ...
        ZK["protocols: zkSNARK line (planned)"]
    end
